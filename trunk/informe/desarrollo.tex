...
\begin{itemize}
 ...
 \item Finalmente, una vez que se habilit\'o paginaci\'on, procedemos a escribir por pantalla el nombre del grupo a trav\'es de la direcci\'on de memria 0x13000, que por como est\'a mapeado, es equivalente a escribir en la posici\'on 0xB8000 (memoria de video).
\end{itemize}
